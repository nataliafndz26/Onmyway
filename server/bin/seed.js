...
const jobs = [
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1536337005238-94b997371b40?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
...
Promise.all([createUsers, createJobs, createPreferences])
    ...
    .then(() => User.findByIdAndUpdate(theUsers[4], { preferences: thePreferences[25] }, { new: true }))
    .then(() => User.findByIdAndUpdate(theUsers[5], { preferences: thePreferences[26] }, { new: true }))
